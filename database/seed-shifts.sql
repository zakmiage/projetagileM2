...
-- ─────────────────────────────────────────────────────────────────────────────
-- EVENT 2 : WEI 2024 — Ven 20 sep → Dim 22 sep 2024
-- Planning week-end d'intégration (3 jours)
-- ─────────────────────────────────────────────────────────────────────────────
INSERT INTO shifts (event_id, label, start_time, end_time, capacity) VALUES
  -- Vendredi
  (2, 'Accueil arrivées — Vendredi', '2024-09-20 08:00:00', '2024-09-20 12:00:00', 6),
  (2, 'Cuisine déjeuner',            '2024-09-20 11:00:00', '2024-09-20 14:00:00', 4),
  (2, 'Animation soirée',            '2024-09-20 20:00:00', '2024-09-21 01:00:00', 5),
  -- Samedi
  (2, 'Activités sportives matin',   '2024-09-21 09:00:00', '2024-09-21 12:30:00', 8),
  (2, 'BBQ déjeuner',                '2024-09-21 11:30:00', '2024-09-21 14:00:00', 5),
  (2, 'Soirée thème',                '2024-09-21 20:00:00', '2024-09-22 02:00:00', 6),
  -- Dimanche
  (2, 'Petit-déjeuner dimanche',     '2024-09-22 08:00:00', '2024-09-22 10:00:00', 4),
  (2, 'Rangement & départ',          '2024-09-22 13:00:00', '2024-09-22 18:00:00', 8);
...
SET @wei_accueil    = (SELECT id FROM shifts WHERE event_id=2 AND label='Accueil arrivées — Vendredi' LIMIT 1);
SET @wei_sport      = (SELECT id FROM shifts WHERE event_id=2 AND label='Activités sportives matin' LIMIT 1);
SET @wei_bbq        = (SELECT id FROM shifts WHERE event_id=2 AND label='BBQ déjeuner' LIMIT 1);
SET @wei_range      = (SELECT id FROM shifts WHERE event_id=2 AND label='Rangement & départ' LIMIT 1);
...
-- Inscriptions WEI
INSERT INTO shift_registrations (shift_id, member_id) VALUES
  (@wei_accueil, 5), (@wei_accueil, 6), (@wei_accueil, 7),
  (@wei_sport, 1), (@wei_sport, 2), (@wei_sport, 3), (@wei_sport, 4), (@wei_sport, 5),
  (@wei_bbq, 8), (@wei_bbq, 9),
  (@wei_range, 1), (@wei_range, 3), (@wei_range, 5), (@wei_range, 7), (@wei_range, 9), (@wei_range, 10);
